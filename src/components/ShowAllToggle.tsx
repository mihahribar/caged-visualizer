...
export default function ShowAllToggle({ showAllShapes, onToggle }: ShowAllToggleProps) {
  return (
    <div className="flex justify-center mb-8">
      <button
        onClick={onToggle}
        className={`px-6 py-2 rounded-full text-sm font-medium transition-colors focus:ring-2 focus:ring-offset-2 dark:focus:ring-offset-gray-900 focus:outline-none ${
          showAllShapes 
